...
const SERVICES = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Протез AcryFree", desc: "Без акрила, гибкий и комфортный, не вызывает аллергии", price: "от 41 400 ₽" },
      { name: "Нейлоновый протез", desc: "Мягкий и эластичный, практически незаметный", price: "от 41 400 ₽" },
    ]
  },
  {
    id: "budget",
