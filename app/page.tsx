...
function DirectionsButton() {
  ...
  return (
    <button
      onClick={openMaps}
      disabled={loading}
      aria-label="Построить маршрут до клиники"
      className="bg-green-600 hover:bg-green-700 text-white px-8 py-4 rounded-lg font-semibold text-lg transition inline-block ml-4 flex items-center justify-center"
    >
      {loading ? (
        <svg
